    ...
    max-w-7xl mx-auto"
      >
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10 items-center">
          ...
          <li>
            <a
              href="https://github.com/ujjwal-A"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/ujjwal-agrawal-ui/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="text-secondary hover:text-white transition-colors duration-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452H16.89v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a1.98 1.98 0 01-1.976-1.981 1.98 1.98 0 011.976-1.98 1.98 1.98 0 011.976 1.98 1.98 1.98 0 01-1.976 1.981zm1.808 13.019H3.53V9h3.615v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </a>
          </li>
        </ul>
